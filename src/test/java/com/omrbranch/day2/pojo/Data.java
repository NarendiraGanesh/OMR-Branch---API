package com.omrbranch.day2.pojo;
...
public class Data {
	...
	public int getAdmin_verified() {
		return admin_verified;
	}
	public void setAdmin_verified(int admin_verified) {
		this.admin_verified = admin_verified;
	}
	public String getFlight_access() {
		return flight_access;
	}
	public void setFlight_access(String flight_access) {
		this.flight_access = flight_access;
	}
