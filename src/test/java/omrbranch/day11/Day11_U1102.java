...
public class Day11_U1102 extends BaseClass {
	...
	private void getSearchResult() {
		...
		for (GetSearchResult data : datas) {
			...
			ArrayList<com.omrbranch.day9.pojo.Variation> variations = data.getVariations();
			for (com.omrbranch.day9.pojo.Variation variation : variations) {
